                ...
                <motion.div className='accordionBody' style={{translateY: panel1YSpring,maxHeight:'2000px',padding:'30px 0'}}>
                    <div className='SandE'>
                        ...
                        <div className='SandEtxt'>
                            I'm a professional front-end developer and throughout my career and degree I have developed 
                            many big projects along with small assignments under my own or as a team member. 
                            While making these projects I have continuously developed myself side by side. 
                            I have used different technologies, mainly JavaScript, React, Redux, C, Python, 
                            ...
                            Speaking of my team members, they love to work with me and probably hold no complains. 
                            I may not be the official leader every time but I always 
                            stepped up to track the process, providing a helping hand and sometimes to 
                            cheer them, so we can finish it within the deadline maintaining a healthy relationship. Finally, I try to code by fully 
                            understanding the flow and thinking as the targeted audience, and having many online community and developer friends make me a better developer.
                            <br/>
                    ...
                    <HTMLFlipBook width={350} height={400} className="magazine">
                        ...
                        <div>
                            <div key={2} className='page innerpage innerpagetxt'>
                                <div>
                                    <h6>And thus always hoping for an opportunity as a way to 
                                    ...
                                    <h6>Another of my dream is to plant more trees than Mrs. Saalumarada 
                                        Thimmakka and make the environment little better.
                                    </h6>
                                </div>
                            ...
                            <div key={3} className='page innerpage'>
                                <div>
                                    ...
                                    <h6>I always try to save time to read books and sometime to write a diary. 
                                        It give me a fresh mind to complete all the task.
                                    </h6>
                                    <div className="diary">
